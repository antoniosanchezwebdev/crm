...
<head>
    <meta charset="UTF-8">
    <title>Presupuesto de Neumalgex</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            Presupuesto de Neumalgex
        </div>
        <p>Estimado/a <strong>{{ $cliente->nombre }}</strong>,</p>
        <p>Adjunto a este correo encontrará su presupuesto. Le pedimos que la revise a la mayor brevedad posible.</p>

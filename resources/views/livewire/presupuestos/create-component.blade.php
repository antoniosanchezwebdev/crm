<div id="contenedorPresupuestosCreate">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row d-flex align-items-center">
                            <label for="fecha_emision" class="col-sm-3 col-form-label">Fecha de emisión</label>
                            <div class="col-sm-9">
                        ...
                        <div class="mb-3 row d-flex align-items-center">
                            <label for="numero_presupuesto" class="col-sm-3 col-form-label">Número de
                                presupuesto</label>
                            <div class="col-sm-9">
                        ...
                        <div class="mb-3 row d-flex align-items-center">
                            <label for="observaciones" class="col-sm-3 col-form-label">Comentario</label>
                            <div class="col-sm-9">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row d-flex align-items-center">
                            ...
                            @if ($producto_seleccionado != null)
                                <label for="prod_sel" class="col-sm-3 col-form-label">Producto seleccionado:</label>
                                <div class="col-sm-9">
                                ...
                                @if ($productos->where('id', $producto_seleccionado)->first()->mueve_existencias != 0)
                                    <label for="exis_sel" class="col-sm-3 col-form-label">Existencias
                                        disponibles:</label>
                                    <div class="col-sm-9">

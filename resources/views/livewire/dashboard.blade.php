    ...
    <div class="row col-12 justify-content-center">
        <div class="col-12 mb-3 mt-3">
                @if ($jornada_activa == 1)
                    ...
                    @else
                        <button class="btn btn-lg btn-success mt-3 w-100" wire:click="iniciarPausa">INICIAR DESAYUNO</button>
                        <button class="btn btn-lg btn-secondary mt-3 w-100" wire:click="iniciarPausa">INICIAR IR A COMPRAR</button>
                        <button class="btn btn-lg btn-warning mt-3 w-100" wire:click="iniciarPausa">INICIAR MANTENIMIENTO</button>
                    @endif
                @else
